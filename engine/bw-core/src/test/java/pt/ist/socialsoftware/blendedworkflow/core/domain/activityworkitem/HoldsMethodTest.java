...
public class HoldsMethodTest extends TeardownRollbackTest {
	...
	public void pastAttributeInstanceDefForEntityDef() {
		...
		boolean result = activityWorkItem.holds(this.activity.getPreConditionSet(),
				this.activity.getPostConditionSet());
		assertTrue(result);
	}
	...
	public void pastEntityInstanceDefForEntityDef() {
		this.activity.addPreCondition(this.defPathCondition);
		this.activity.addPostCondition(this.defEntityCondition);
