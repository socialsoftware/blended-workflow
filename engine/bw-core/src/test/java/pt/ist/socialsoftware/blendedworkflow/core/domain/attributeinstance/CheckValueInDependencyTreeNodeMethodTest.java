...
public class CheckValueInDependencyTreeNodeMethodTest extends TeardownRollbackTest {
	...
	public void emptyValueCheck() {
		...
		try {
			attributeInstanceDto.getAttributeInstance(workflowInstance, attributeInstanceDto.getExternalId()).get()
				.checkSkippedAttributeInstance(attributeInstanceDto);
			fail();
	...
	@Test
	public void incorrectValueTypeCheck() {
