app.directive('goalGraph', function($window) {
	return {
		restrict : 'EA',
		template : "<svg width='1100' height='900'></svg>",
		link : function(scope, elem, attrs) {
			scope.$watch(attrs.goalData, function(goalData) {
				
			var dataToPlot = scope[attrs.goalData];
