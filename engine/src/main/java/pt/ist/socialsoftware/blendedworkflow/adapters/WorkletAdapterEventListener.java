...
public class WorkletAdapterEventListener extends WorkletEventListener {
    ...
    private static Logger log = LoggerFactory
            .getLogger("WorkletAdapterEventListener");
    ...
    @Override
    public void itemLevelExceptionEvent(WorkItemRecord wir, Element caseData,
            RdrNode rdrNode, RuleType ruleType) {
        // log.debug("ItemLevelExceptionEvent for WorkItemRecord: " + wir +
        // " begin.");
    ...
    @Override
    public void constraintSuccessEvent(String caseID, WorkItemRecord wir,
            Element caseData, RuleType ruleType) {
        log.error("FAILURE: no RdrNode for the " + wir.getTaskName() + "Task");
        // log.debug("ConstraintSuccessEvent for WorkItemRecord: " + wir +
        // " begin.");
        // if (yawlFlow) {
        // Transaction.begin();
        ...
        // ProcessConstrainSucessEvent task = new
        // ProcessConstrainSucessEvent(caseID, wir, caseData, ruleType);
        // bwExecutorService.runTask(task);
    ...
    @Override
    public void caseLevelExceptionEvent(String caseID, Element caseData,
            RdrNode rdrNode, RuleType ruleType) {
    }
