...
public class DataModelTree extends VerticalLayout {
            ...
            public void buttonClick(ClickEvent event) {
                if (treetable.getValue() != null) {
                    if (treetable.hasChildren(treetable.getValue())) {
                        ...
                        String entity = treetable
                                .getParent(treetable.getValue()).toString();
                        showConstrainsWindow(entity, attribute, "",
                                "Attribute");
                    }
                }
                    ...
                    if (relationtable.hasChildren(relationtable.getValue())) {
                        ...
                        Object entityO = relationtable
                                .getParent(relationtable.getValue());
                        String relation = (String) relationtable
                                .getParent(entityO);

                        String attribute = relationtable.getValue().toString();
                        String entity = relationtable
                                .getParent(relationtable.getValue()).toString();
        ...
        cancelButton.addListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                getApplication().getMainWindow()
                        .removeWindow(DataModelTree.this.getWindow());
            }
        });
    ...
    public void getDataModel(String bwInstanceOID) {
        ...
        for (RelationBW relation : dataModelInstance.getRelationsSet()) {
            if (context.equals(relation.getEntityOne())) {
                ...
                for (AttributeBasic attribute : e.getAttributeBasicSet()) {
                    String attributeName = attribute.getName();
    ...
    protected void showConstrainsWindow(String entity, String attribute,
        ...
        newConstrain.setContent(
                new ConstrainsForm(this, entity, attribute, relation, type));
        newConstrain.center();
