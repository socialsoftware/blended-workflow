...
public class DoctorAppointmentForm extends VerticalLayout {
    ...
    private final TextField medicalPrescriptionTF = new TextField(
            "Description");
        ...
        submitButton.addListener(new ClickListener() {
            ...
            public void buttonClick(ClickEvent event) {
                ...
                getApplication().getMainWindow()
                        .removeWindow(DoctorAppointmentForm.this.getWindow());
            }
        });
    ...
    private void createMedicalPrescription() {
        ...
        BWAttribute description = medicalPrescription
        ...
        BlendedWorkflow.getInstance().getBwManager().addRelationInstance(
                bwInstanceOID, episodeOID, medicalPrescription1OID);
        first = false;
    }
    ...
    public void prescriptionMedication(String number, String name,
        ...
        prescriptionMedicationTable.addItem(
                new Object[] { number, name, quantity, heartImpact },
                new Integer(index + 1));
    }
    ...
    protected void showDataModelTreeWindow(String bwInstanceOID) {
        ...
        dataModel.setContent(
                new PrescriptionMedicationForm(this, bwInstanceOID));
        dataModel.center();
