...
public class OldAttributeInstance extends OldAttributeInstance_Base {
	...
	public OldAttributeInstance(Attribute attribute, OldEntityInstance entityInstance) {
	...
	public void cloneAttributeInstance(OldDataModelInstance dataModelInstance, OldEntityInstance newEntityInstance) {
		OldAttributeInstance newAttributeInstance = new OldAttributeInstance(getAttribute(), newEntityInstance);
