...
public class AttributeBasic extends AttributeBasic_Base {
    ...
    public static enum AttributeType {
        ...
        public static AttributeBasic.AttributeType parseAttributeType(
                String type) {
    ...
    public AttributeBasic(DataModel dataModel, Entity entity,
            AttributeGroup group, String name, AttributeType type,
    ...
    public void cloneAttribute(DataModelInstance dataModelInstance,
        ...
        new AttributeBasic(dataModelInstance, entity, getAttributeGroup(),
