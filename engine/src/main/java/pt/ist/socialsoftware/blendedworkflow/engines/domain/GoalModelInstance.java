...
public class GoalModelInstance extends GoalModelInstance_Base {
	...
	public Set<MaintainGoal> getAchieveGoalAssociatedMaintainGoals(
		...
		for (MaintainGoal maintainGoal : getMaintainGoalsSet()) {
			...
			achieveAttributes.addAll(achieveGoal.getSucessCondition()
					.getAttributes());
			achieveEntities.addAll(achieveGoal.getSucessCondition()
					.getEntities());
			...
			maintainAttributes.addAll(maintainGoal.getMaintainCondition()
					.getAttributes());
			maintainEntities.addAll(maintainGoal.getMaintainCondition()
					.getEntities());
