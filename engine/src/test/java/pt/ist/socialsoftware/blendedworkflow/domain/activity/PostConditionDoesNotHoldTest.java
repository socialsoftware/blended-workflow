...
public class PostConditionDoesNotHoldTest extends TeardownRollbackTest {
	...
	public void attributeIsNotDefined() {
		...
		boolean result = activity.postConditionDoesNotHold(entityInstance);
	...
	public void twoAttributesOneIsNotDefined() {
		...
		activity.addPreCondition(DefPathCondition.getDefPathCondition(spec, ENT_ONE_NAME));
		activity.addPostCondition(DefAttributeCondition.getDefAttributeCondition(attOne));
		activity.addPostCondition(DefAttributeCondition.getDefAttributeCondition(attTwo));
	...
	public void entityAssociationIsFull() {
		...
		boolean result = activity.postConditionDoesNotHold(entityInstanceOne);
	...
	@Test
	public void entityAssociationIsAlmostFullAndHasDefinedAttribute() {
		Activity activity = new Activity(spec.getActivityModel(), "name", "description");
		activity.addPreCondition(DefPathCondition.getDefPathCondition(spec, ENT_ONE_NAME));
		activity.addPostCondition(DefEntityCondition.getDefEntityCondition(entTwo));
		activity.addPostCondition(DefAttributeCondition.getDefAttributeCondition(attThree));
		activity.addMultiplicityInvariant(MulCondition.getMulCondition(relationOne, ROLENAME_ENT_ONE));
		activity.addMultiplicityInvariant(MulCondition.getMulCondition(relationOne, ROLENAME_ENT_TWO));
		...
		EntityInstance entityInstanceTwo = new EntityInstance(workflowInstance, entTwo);
		new RelationInstance(entityInstanceOne, entityInstanceTwo, relationOne);
		new AttributeInstance(entityInstanceTwo, attThree, "123");
