...
public class CreateAttributeMethodTest extends TeardownRollbackTest {
	...
	public void populate4Test() throws BWException {
		...
		new Attribute(spec.getDataModel(), entity, EXISTS_NAME, AttributeType.BOOLEAN, true, false, false);
	}

	@Test
	public void success() {
		Attribute att1 = entity.createAttribute(ATT_NAME_ONE, AttributeType.STRING, true);
		Attribute att2 = entity.createAttribute(ATT_NAME_TWO, AttributeType.BOOLEAN, false);
		Attribute att3 = entity.createAttribute(ATT_NAME_THREE, AttributeType.NUMBER, false);

		assertEquals(4, entity.getAttributeSet().size());
	...
	public void successWithGroup() {
		...
		assertEquals(2, entity.getAttributeSet().size());
		assertEquals(ATT_NAME_ONE, att1.getName());
		assertEquals(att1, entity.getAttribute(ATT_NAME_ONE).orElse(null));
		assertEquals(AttributeType.STRING, att1.getType());
	}
	...
	public void existsName() {
		try {
			entity.createAttribute(EXISTS_NAME, AttributeType.NUMBER, true);
	...
	public void emptyName() {
		try {
			entity.createAttribute(EMPTY_NAME, AttributeType.BOOLEAN, true);
	...
	public void nullName() {
		try {
			entity.createAttribute(null, AttributeType.STRING, true);
