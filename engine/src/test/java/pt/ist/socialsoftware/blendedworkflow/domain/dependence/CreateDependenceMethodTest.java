...
public class CreateDependenceMethodTest extends TeardownRollbackTest {
	private static String DEPENDENCE = "Entity name" + "." + "rolename.attribute";
	...
	public void populate4Test() throws BWException {
		...
		attributeGroup = new AttributeGroup(spec.getDataModel(), entity, "att1", true);
		attributeBasic = new AttributeBasic(spec.getDataModel(), entity, null, "att2", AttributeType.BOOLEAN, true,
				false, false);
	}
	...
	public void successEntity() {
		...
		assertEquals(DEPENDENCE, entity.getDependenceSet().stream().findFirst().get().getPath().getValue());
	}
