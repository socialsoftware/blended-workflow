...
public class YAWLAdapterTestInterface extends Application {
    ...
    private static Logger log = LoggerFactory
            .getLogger("YAWLAdapterTestInterface");
    ...
    public void init() {
        ...
        registrationButtons.addComponent(
                new Button("Connect to Yawl", new Button.ClickListener() {
                    @Override
        ...
        registrationButtons.addComponent(
                new Button("Disconnect to Yawl", new Button.ClickListener() {
                    @Override
                    public void buttonClick(ClickEvent event) {
                        try {
                            BlendedWorkflow.getInstance().getYawlAdapter()
        ...
        registrationButtons.addComponent(
                new Button("Get Connection State", new Button.ClickListener() {
                    @Override
                    public void buttonClick(ClickEvent event) {
                        try {

                            log.debug("Clients Registered:");
                            for (YExternalClient client : yawlAdapter
                                    .getClientAccounts()) {
                                log.debug(client.getUserName());
                            }
                            log.debug("Services Registered:");
                            for (YAWLServiceReference service : yawlAdapter
        ...
        specButtons.addComponent(
                new Button("Load Specification", new Button.ClickListener() {
                    @Override
                    public void buttonClick(ClickEvent event) {
                        try {
                            String spec = StringUtils
                                    .fileToString(YAWL_SPEC_FILENAME);
        ...
        specButtons.addComponent(
                new Button("Unload Specification", new Button.ClickListener() {
                    @Override
                    public void buttonClick(ClickEvent event) {
                        try {
                            BlendedWorkflow.getInstance().getYawlAdapter()
                                    .unloadSpecification(specID);
                            results.setValue(
                                    " Unload Specification - Sucesso!");
                        } catch (Exception e) {
        ...
        specButtons.addComponent(new Button("Get Loaded Specifications",
                new Button.ClickListener() {
                    ...
                    public void buttonClick(ClickEvent event) {
                        try {
                            ...
                            for (SpecificationData specification : yawlAdapter
                                    .getLoadedSpecs()) {
                                log.debug(specification.getName());
                            }

                            results.setValue(
                                    "Get Loaded Specifications - Sucesso!");
                        } catch (Exception e) {
                            results.setValue(
                                    "Get Loaded Specifications - Fail!");
                        }
                    }
                }));

        // Case Buttons
        caseButtons.addComponent(
                new Button("Launch Specification", new Button.ClickListener() {
                    @Override
                    public void buttonClick(ClickEvent event) {
                        try {
                            String spec = StringUtils
        ...
        caseButtons.addComponent(
                new Button("Cancel Case", new Button.ClickListener() {
                    @Override
                    public void buttonClick(ClickEvent event) {
                        try {
                            BlendedWorkflow.getInstance().getYawlAdapter()
                                    .cancelCase(caseInstanceID);
