...
public class GenerateConditionsMethodTest extends TeardownRollbackTest {
    ...
    public void success() {
        ...
        assertEquals(0,
                conditionModel.getAttributeAchieveConditionSet().size());
        assertEquals(0, conditionModel.getEntityInvariantConditionSet().size());
        assertEquals(0,
                conditionModel.getAttributeInvariantConditionSet().size());
        assertEquals(0,
                conditionModel.getEntityDependenceConditionSet().size());
        assertEquals(0,
                conditionModel.getAttributeDependenceConditionSet().size());
