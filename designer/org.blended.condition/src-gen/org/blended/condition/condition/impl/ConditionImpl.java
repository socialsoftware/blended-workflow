 ...
 * </p>
 * <ul>
 *   <li>{@link org.blended.condition.condition.impl.ConditionImpl#getEntityAchieveConditions <em>Entity Achieve Conditions</em>}</li>
 *   <li>{@link org.blended.condition.condition.impl.ConditionImpl#getEntityInvariantConditions <em>Entity Invariant Conditions</em>}</li>
 *   <li>{@link org.blended.condition.condition.impl.ConditionImpl#getEntityDependenceConditions <em>Entity Dependence Conditions</em>}</li>
 *   <li>{@link org.blended.condition.condition.impl.ConditionImpl#getAttributeAchieveConditions <em>Attribute Achieve Conditions</em>}</li>
 *   <li>{@link org.blended.condition.condition.impl.ConditionImpl#getAttributeInvariantConditions <em>Attribute Invariant Conditions</em>}</li>
 *   <li>{@link org.blended.condition.condition.impl.ConditionImpl#getAttributeDependenceConditions <em>Attribute Dependence Conditions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionImpl extends MinimalEObjectImpl.Container implements Condition
{
  ...
  public EList<EObject> getEntityAchieveConditions()
  {
    ...
    {
      entityAchieveConditions = new EObjectContainmentEList<EObject>(EObject.class, this, ConditionPackage.CONDITION__ENTITY_ACHIEVE_CONDITIONS);
    }
  ...
  public EList<EntityInvariantCondition> getEntityInvariantConditions()
  {
    ...
    {
      entityInvariantConditions = new EObjectContainmentEList<EntityInvariantCondition>(EntityInvariantCondition.class, this, ConditionPackage.CONDITION__ENTITY_INVARIANT_CONDITIONS);
    }
  ...
  public EList<EntityDependenceCondition> getEntityDependenceConditions()
  {
    ...
    {
      entityDependenceConditions = new EObjectContainmentEList<EntityDependenceCondition>(EntityDependenceCondition.class, this, ConditionPackage.CONDITION__ENTITY_DEPENDENCE_CONDITIONS);
    }
  ...
  public EList<AttributeAchieveCondition> getAttributeAchieveConditions()
  {
    ...
    {
      attributeAchieveConditions = new EObjectContainmentEList<AttributeAchieveCondition>(AttributeAchieveCondition.class, this, ConditionPackage.CONDITION__ATTRIBUTE_ACHIEVE_CONDITIONS);
    }
  ...
  public EList<AttributeInvariantCondition> getAttributeInvariantConditions()
  {
    ...
    {
      attributeInvariantConditions = new EObjectContainmentEList<AttributeInvariantCondition>(AttributeInvariantCondition.class, this, ConditionPackage.CONDITION__ATTRIBUTE_INVARIANT_CONDITIONS);
    }
  ...
  public EList<AttributeDependenceCondition> getAttributeDependenceConditions()
  {
    ...
    {
      attributeDependenceConditions = new EObjectContainmentEList<AttributeDependenceCondition>(AttributeDependenceCondition.class, this, ConditionPackage.CONDITION__ATTRIBUTE_DEPENDENCE_CONDITIONS);
    }
