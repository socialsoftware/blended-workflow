...
class ConditionGeneratorActivityModel {
	...
	def step1(Activity activity, EObject o) {
	...
	def step4(EntityInvariantCondition o) {
		...
		if (act1 == null) act2.post.add(o.copy)
		else if (act2 == null) act1.post.add(o.copy)		
		else if (act1.name > act2.name) act1.post.add(o.copy)
		else act2.post.add(o.copy)
	}
