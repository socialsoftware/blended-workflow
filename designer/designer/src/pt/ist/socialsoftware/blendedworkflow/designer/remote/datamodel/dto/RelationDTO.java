...
public class RelationDTO {
	...
	public RelationDTO(String specId, String name, String entOneName, String rolenameOne, String cardinalityOne,
			String entTwoName, String rolenameTwo, String cardinalityTwo) {
		this.specId = specId;
		this.extId = null;
		this.name = name;
