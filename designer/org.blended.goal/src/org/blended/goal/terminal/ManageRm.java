...
public class ManageRm {
    public static void entity(GoalModel model, String name, CommandRm cmd)
        ...
        // }
        // else ConsoleManagement.write(name, "Operation NOT performed. Entity
        // not found");
        // } else throw new ValueException("Parameter not valid: The following
        // option is required: -v working with specifications");
    }
