 ...
 * </p>
 * <ul>
 *   <li>{@link org.blended.goal.goal.impl.GoalImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.blended.goal.goal.impl.GoalImpl#getSucessCondition <em>Sucess Condition</em>}</li>
 *   <li>{@link org.blended.goal.goal.impl.GoalImpl#getActivationCondition <em>Activation Condition</em>}</li>
 *   <li>{@link org.blended.goal.goal.impl.GoalImpl#getInvariantConditions <em>Invariant Conditions</em>}</li>
 *   <li>{@link org.blended.goal.goal.impl.GoalImpl#getChildrenGoals <em>Children Goals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GoalImpl extends MinimalEObjectImpl.Container implements Goal
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GoalPackage.GOAL__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetSucessCondition(EObject newSucessCondition, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GoalPackage.GOAL__SUCESS_CONDITION, oldSucessCondition, newSucessCondition);
  ...
  public void setSucessCondition(EObject newSucessCondition)
  {
    if (newSucessCondition != sucessCondition)
    {
      ...
      if (sucessCondition != null)
        msgs = ((InternalEObject)sucessCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GoalPackage.GOAL__SUCESS_CONDITION, null, msgs);
      if (newSucessCondition != null)
        msgs = ((InternalEObject)newSucessCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GoalPackage.GOAL__SUCESS_CONDITION, null, msgs);
      msgs = basicSetSucessCondition(newSucessCondition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GoalPackage.GOAL__SUCESS_CONDITION, newSucessCondition, newSucessCondition));
  }
  ...
  public NotificationChain basicSetActivationCondition(EObject newActivationCondition, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GoalPackage.GOAL__ACTIVATION_CONDITION, oldActivationCondition, newActivationCondition);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setActivationCondition(EObject newActivationCondition)
  {
    if (newActivationCondition != activationCondition)
    {
      ...
      if (activationCondition != null)
        msgs = ((InternalEObject)activationCondition).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GoalPackage.GOAL__ACTIVATION_CONDITION, null, msgs);
      if (newActivationCondition != null)
        msgs = ((InternalEObject)newActivationCondition).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GoalPackage.GOAL__ACTIVATION_CONDITION, null, msgs);
      msgs = basicSetActivationCondition(newActivationCondition, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GoalPackage.GOAL__ACTIVATION_CONDITION, newActivationCondition, newActivationCondition));
  }
  ...
  public EList<EObject> getInvariantConditions()
  {
    ...
    {
      invariantConditions = new EObjectContainmentEList<EObject>(EObject.class, this, GoalPackage.GOAL__INVARIANT_CONDITIONS);
    }
  ...
  public EList<Goal> getChildrenGoals()
  {
    ...
    {
      childrenGoals = new EObjectResolvingEList<Goal>(Goal.class, this, GoalPackage.GOAL__CHILDREN_GOALS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GoalPackage.GOAL__SUCESS_CONDITION:
        return basicSetSucessCondition(null, msgs);
      case GoalPackage.GOAL__ACTIVATION_CONDITION:
        return basicSetActivationCondition(null, msgs);
      case GoalPackage.GOAL__INVARIANT_CONDITIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case GoalPackage.GOAL__CHILDREN_GOALS:
