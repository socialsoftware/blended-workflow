 ...
 * </p>
 * <ul>
 *   <li>{@link org.blended.goal.goal.impl.AttributeAchieveConditionImpl#getConditions <em>Conditions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributeAchieveConditionImpl extends MinimalEObjectImpl.Container implements AttributeAchieveCondition
{
  ...
  {
    return GoalPackage.Literals.ATTRIBUTE_ACHIEVE_CONDITION;
  }
  ...
  public EList<String> getConditions()
  {
    if (conditions == null)
    {
      conditions = new EDataTypeEList<String>(String.class, this, GoalPackage.ATTRIBUTE_ACHIEVE_CONDITION__CONDITIONS);
    }
    return conditions;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GoalPackage.ATTRIBUTE_ACHIEVE_CONDITION__CONDITIONS:
