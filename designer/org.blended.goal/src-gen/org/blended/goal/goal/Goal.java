 ...
 * </p>
 * <ul>
 *   <li>{@link org.blended.goal.goal.Goal#getName <em>Name</em>}</li>
 *   <li>{@link org.blended.goal.goal.Goal#getSucessCondition <em>Sucess Condition</em>}</li>
 *   <li>{@link org.blended.goal.goal.Goal#getActivationCondition <em>Activation Condition</em>}</li>
 *   <li>{@link org.blended.goal.goal.Goal#getInvariantConditions <em>Invariant Conditions</em>}</li>
 *   <li>{@link org.blended.goal.goal.Goal#getChildrenGoals <em>Children Goals</em>}</li>
 * </ul>
 *
 * @see org.blended.goal.goal.GoalPackage#getGoal()
 * @model
 * @generated
 */
public interface Goal extends EObject
{
   ...
   * @see #setName(String)
   * @see org.blended.goal.goal.GoalPackage#getGoal_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.blended.goal.goal.Goal#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.blended.goal.goal.GoalPackage#getGoal_SucessCondition()
  ...
  /**
   * Sets the value of the '{@link org.blended.goal.goal.Goal#getSucessCondition <em>Sucess Condition</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.blended.goal.goal.GoalPackage#getGoal_ActivationCondition()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.blended.goal.goal.Goal#getActivationCondition <em>Activation Condition</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.blended.goal.goal.GoalPackage#getGoal_InvariantConditions()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.blended.goal.goal.GoalPackage#getGoal_ChildrenGoals()
   * @model
   * @generated
   */
