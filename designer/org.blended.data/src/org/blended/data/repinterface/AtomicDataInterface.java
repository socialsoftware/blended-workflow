...
public class AtomicDataInterface {
    private static AtomicDataInterface instance;

    public static AtomicDataInterface getInstance() {
        if (instance == null) {
            instance = new AtomicDataInterface();
        }
        return instance;
    }

    private AtomicDataInterface() {
    }
