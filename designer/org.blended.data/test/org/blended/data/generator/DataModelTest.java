...
public class DataModelTest {
    ...
    public void fromDMtoCMEntityAchieveCondition() {
    	Optional<Entity> ent = dataModel.getEntities()
    			.stream()
    			.filter(e -> e.getName().equals("Episode"))
    			.findFirst();
    	assertTrue(ent.isPresent());
    	dataGen.entityAchieveCondition(ent.get(), conditionModel);
    	Optional<EntityAchieveCondition> entAC = conditionModel.getEntityAchieveConditions()
    			.stream()
    			.filter(e -> e.eClass().getName().equals("EntityAchieveCondition"))
    			.map(e -> (EntityAchieveCondition)e)
    			.filter(e -> e.getName().equals("Episode"))
    			.findFirst();
    ...
    public void fromDMtoCMEntityAchieveConditionExist() {
    	Optional<Entity> ent = dataModel.getEntities()
    			.stream()
    			.filter(e -> e.getName().equals("Patient"))
    			.findFirst();
    	assertTrue(ent.isPresent());
    	dataGen.entityAchieveCondition(ent.get(), conditionModel);
    	Optional<EntityAchieveConditionExist> entAC = conditionModel.getEntityAchieveConditions()
    			.stream()
    			.filter(e -> e.eClass().getName().equals("EntityAchieveConditionExist"))
    			.map(e -> (EntityAchieveConditionExist)e)
    			.filter(e -> e.getName().equals("Patient"))
    			.findFirst();
    	assertTrue(entAC.isPresent());
    }
