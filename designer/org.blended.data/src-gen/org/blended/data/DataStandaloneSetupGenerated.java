...
public class DataStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.blended.data.DataRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.blended.org/data/Data")) {
		EPackage.Registry.INSTANCE.put("http://www.blended.org/data/Data", org.blended.data.data.DataPackage.eINSTANCE);
	}
