...
@Singleton
public class BlendedGrammarAccess extends AbstractGrammarElementFinder {
	
	
	public class BlendedModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "BlendedModel");
		...
		private final RuleCall cActivityParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		...
		//Activity
		public RuleCall getActivityParserRuleCall_2() { return cActivityParserRuleCall_2; }
	}
	...
	public class ConditionElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
		private final Keyword cENTITY_ACHIEVE_CONDITIONSKeyword_1_0 = (Keyword)cGroup_1.eContents().get(0);
		private final Assignment cEntityAchieveConditionsAssignment_1_1 = (Assignment)cGroup_1.eContents().get(1);
		private final Alternatives cEntityAchieveConditionsAlternatives_1_1_0 = (Alternatives)cEntityAchieveConditionsAssignment_1_1.eContents().get(0);
		private final RuleCall cEntityAchieveConditionsEntityAchieveConditionParserRuleCall_1_1_0_0 = (RuleCall)cEntityAchieveConditionsAlternatives_1_1_0.eContents().get(0);
		private final RuleCall cEntityAchieveConditionsEntityAchieveConditionExistParserRuleCall_1_1_0_1 = (RuleCall)cEntityAchieveConditionsAlternatives_1_1_0.eContents().get(1);
		private final Group cGroup_2 = (Group)cGroup.eContents().get(2);
		private final Keyword cENTITY_INVARIANT_CONDITIONSKeyword_2_0 = (Keyword)cGroup_2.eContents().get(0);
		private final Assignment cEntityInvariantConditionsAssignment_2_1 = (Assignment)cGroup_2.eContents().get(1);
		private final RuleCall cEntityInvariantConditionsEntityInvariantConditionParserRuleCall_2_1_0 = (RuleCall)cEntityInvariantConditionsAssignment_2_1.eContents().get(0);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		private final Keyword cENTITY_DEPENDENCE_CONDITIONSKeyword_3_0 = (Keyword)cGroup_3.eContents().get(0);
		private final Assignment cEntityDependenceConditionsAssignment_3_1 = (Assignment)cGroup_3.eContents().get(1);
		private final RuleCall cEntityDependenceConditionsEntityDependenceConditionParserRuleCall_3_1_0 = (RuleCall)cEntityDependenceConditionsAssignment_3_1.eContents().get(0);
		private final Group cGroup_4 = (Group)cGroup.eContents().get(4);
		private final Keyword cATTRIBUTE_ACHIEVE_CONDITIONSKeyword_4_0 = (Keyword)cGroup_4.eContents().get(0);
		private final Assignment cAttributeAchieveConditionsAssignment_4_1 = (Assignment)cGroup_4.eContents().get(1);
		private final RuleCall cAttributeAchieveConditionsAttributeAchieveConditionParserRuleCall_4_1_0 = (RuleCall)cAttributeAchieveConditionsAssignment_4_1.eContents().get(0);
		private final Group cGroup_5 = (Group)cGroup.eContents().get(5);
		private final Keyword cATTRIBUTE_INVARIANT_CONDITIONSKeyword_5_0 = (Keyword)cGroup_5.eContents().get(0);
		private final Assignment cAttributeInvariantConditionsAssignment_5_1 = (Assignment)cGroup_5.eContents().get(1);
		private final RuleCall cAttributeInvariantConditionsAttributeInvariantConditionParserRuleCall_5_1_0 = (RuleCall)cAttributeInvariantConditionsAssignment_5_1.eContents().get(0);
		private final Group cGroup_6 = (Group)cGroup.eContents().get(6);
		private final Keyword cATTRIBUTE_DEPENDENCE_CONDITIONSKeyword_6_0 = (Keyword)cGroup_6.eContents().get(0);
		private final Assignment cAttributeDependenceConditionsAssignment_6_1 = (Assignment)cGroup_6.eContents().get(1);
		private final RuleCall cAttributeDependenceConditionsAttributeDependenceConditionParserRuleCall_6_1_0 = (RuleCall)cAttributeDependenceConditionsAssignment_6_1.eContents().get(0);
		...
		public Keyword getENTITY_ACHIEVE_CONDITIONSKeyword_1_0() { return cENTITY_ACHIEVE_CONDITIONSKeyword_1_0; }

		//entityAchieveConditions+=(EntityAchieveCondition | EntityAchieveConditionExist)*
		public Assignment getEntityAchieveConditionsAssignment_1_1() { return cEntityAchieveConditionsAssignment_1_1; }

		//EntityAchieveCondition | EntityAchieveConditionExist
		public Alternatives getEntityAchieveConditionsAlternatives_1_1_0() { return cEntityAchieveConditionsAlternatives_1_1_0; }

		//EntityAchieveCondition
		public RuleCall getEntityAchieveConditionsEntityAchieveConditionParserRuleCall_1_1_0_0() { return cEntityAchieveConditionsEntityAchieveConditionParserRuleCall_1_1_0_0; }

		//EntityAchieveConditionExist
		public RuleCall getEntityAchieveConditionsEntityAchieveConditionExistParserRuleCall_1_1_0_1() { return cEntityAchieveConditionsEntityAchieveConditionExistParserRuleCall_1_1_0_1; }

		//("ENTITY_INVARIANT_CONDITIONS" entityInvariantConditions+=EntityInvariantCondition*)?
		public Group getGroup_2() { return cGroup_2; }

		//"ENTITY_INVARIANT_CONDITIONS"
		public Keyword getENTITY_INVARIANT_CONDITIONSKeyword_2_0() { return cENTITY_INVARIANT_CONDITIONSKeyword_2_0; }

		//entityInvariantConditions+=EntityInvariantCondition*
		public Assignment getEntityInvariantConditionsAssignment_2_1() { return cEntityInvariantConditionsAssignment_2_1; }

		//EntityInvariantCondition
		public RuleCall getEntityInvariantConditionsEntityInvariantConditionParserRuleCall_2_1_0() { return cEntityInvariantConditionsEntityInvariantConditionParserRuleCall_2_1_0; }

		//("ENTITY_DEPENDENCE_CONDITIONS" entityDependenceConditions+=EntityDependenceCondition*)?
		public Group getGroup_3() { return cGroup_3; }

		//"ENTITY_DEPENDENCE_CONDITIONS"
		public Keyword getENTITY_DEPENDENCE_CONDITIONSKeyword_3_0() { return cENTITY_DEPENDENCE_CONDITIONSKeyword_3_0; }

		//entityDependenceConditions+=EntityDependenceCondition*
		public Assignment getEntityDependenceConditionsAssignment_3_1() { return cEntityDependenceConditionsAssignment_3_1; }

		//EntityDependenceCondition
		public RuleCall getEntityDependenceConditionsEntityDependenceConditionParserRuleCall_3_1_0() { return cEntityDependenceConditionsEntityDependenceConditionParserRuleCall_3_1_0; }

		//("ATTRIBUTE_ACHIEVE_CONDITIONS" attributeAchieveConditions+=AttributeAchieveCondition*)?
		public Group getGroup_4() { return cGroup_4; }

		//"ATTRIBUTE_ACHIEVE_CONDITIONS"
		public Keyword getATTRIBUTE_ACHIEVE_CONDITIONSKeyword_4_0() { return cATTRIBUTE_ACHIEVE_CONDITIONSKeyword_4_0; }

		//attributeAchieveConditions+=AttributeAchieveCondition*
		public Assignment getAttributeAchieveConditionsAssignment_4_1() { return cAttributeAchieveConditionsAssignment_4_1; }

		//AttributeAchieveCondition
		public RuleCall getAttributeAchieveConditionsAttributeAchieveConditionParserRuleCall_4_1_0() { return cAttributeAchieveConditionsAttributeAchieveConditionParserRuleCall_4_1_0; }

		//("ATTRIBUTE_INVARIANT_CONDITIONS" attributeInvariantConditions+=AttributeInvariantCondition*)?
		public Group getGroup_5() { return cGroup_5; }

		//"ATTRIBUTE_INVARIANT_CONDITIONS"
		public Keyword getATTRIBUTE_INVARIANT_CONDITIONSKeyword_5_0() { return cATTRIBUTE_INVARIANT_CONDITIONSKeyword_5_0; }

		//attributeInvariantConditions+=AttributeInvariantCondition*
		public Assignment getAttributeInvariantConditionsAssignment_5_1() { return cAttributeInvariantConditionsAssignment_5_1; }

		//AttributeInvariantCondition
		public RuleCall getAttributeInvariantConditionsAttributeInvariantConditionParserRuleCall_5_1_0() { return cAttributeInvariantConditionsAttributeInvariantConditionParserRuleCall_5_1_0; }

		//("ATTRIBUTE_DEPENDENCE_CONDITIONS" attributeDependenceConditions+=AttributeDependenceCondition*)?
		public Group getGroup_6() { return cGroup_6; }

		//"ATTRIBUTE_DEPENDENCE_CONDITIONS"
		public Keyword getATTRIBUTE_DEPENDENCE_CONDITIONSKeyword_6_0() { return cATTRIBUTE_DEPENDENCE_CONDITIONSKeyword_6_0; }

		//attributeDependenceConditions+=AttributeDependenceCondition*
		public Assignment getAttributeDependenceConditionsAssignment_6_1() { return cAttributeDependenceConditionsAssignment_6_1; }

		//AttributeDependenceCondition
		public RuleCall getAttributeDependenceConditionsAttributeDependenceConditionParserRuleCall_6_1_0() { return cAttributeDependenceConditionsAttributeDependenceConditionParserRuleCall_6_1_0; }
	}
	...
	public class GoalElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cSUCKeyword_2 = (Keyword)cGroup.eContents().get(2);
		private final Keyword cLeftParenthesisKeyword_3 = (Keyword)cGroup.eContents().get(3);
		private final Assignment cSucessConditionAssignment_4 = (Assignment)cGroup.eContents().get(4);
		private final Alternatives cSucessConditionAlternatives_4_0 = (Alternatives)cSucessConditionAssignment_4.eContents().get(0);
		private final RuleCall cSucessConditionEntityAchieveConditionParserRuleCall_4_0_0 = (RuleCall)cSucessConditionAlternatives_4_0.eContents().get(0);
		private final RuleCall cSucessConditionAttributeAchieveConditionParserRuleCall_4_0_1 = (RuleCall)cSucessConditionAlternatives_4_0.eContents().get(1);
		private final RuleCall cSucessConditionNothingParserRuleCall_4_0_2 = (RuleCall)cSucessConditionAlternatives_4_0.eContents().get(2);
		private final Keyword cRightParenthesisKeyword_5 = (Keyword)cGroup.eContents().get(5);
		private final Group cGroup_6 = (Group)cGroup.eContents().get(6);
		private final Keyword cCommaKeyword_6_0 = (Keyword)cGroup_6.eContents().get(0);
		private final Keyword cACTKeyword_6_1 = (Keyword)cGroup_6.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_6_2 = (Keyword)cGroup_6.eContents().get(2);
		private final Assignment cActivationConditionAssignment_6_3 = (Assignment)cGroup_6.eContents().get(3);
		private final Alternatives cActivationConditionAlternatives_6_3_0 = (Alternatives)cActivationConditionAssignment_6_3.eContents().get(0);
		private final RuleCall cActivationConditionEntityAchieveConditionParserRuleCall_6_3_0_0 = (RuleCall)cActivationConditionAlternatives_6_3_0.eContents().get(0);
		private final RuleCall cActivationConditionAttributeAchieveConditionParserRuleCall_6_3_0_1 = (RuleCall)cActivationConditionAlternatives_6_3_0.eContents().get(1);
		private final Keyword cRightParenthesisKeyword_6_4 = (Keyword)cGroup_6.eContents().get(4);
		private final Group cGroup_7 = (Group)cGroup.eContents().get(7);
		private final Keyword cCommaKeyword_7_0 = (Keyword)cGroup_7.eContents().get(0);
		private final Keyword cINVKeyword_7_1 = (Keyword)cGroup_7.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_7_2 = (Keyword)cGroup_7.eContents().get(2);
		private final Assignment cInvariantConditionsAssignment_7_3 = (Assignment)cGroup_7.eContents().get(3);
		private final Alternatives cInvariantConditionsAlternatives_7_3_0 = (Alternatives)cInvariantConditionsAssignment_7_3.eContents().get(0);
		private final RuleCall cInvariantConditionsEntityInvariantConditionParserRuleCall_7_3_0_0 = (RuleCall)cInvariantConditionsAlternatives_7_3_0.eContents().get(0);
		private final RuleCall cInvariantConditionsAttributeInvariantConditionParserRuleCall_7_3_0_1 = (RuleCall)cInvariantConditionsAlternatives_7_3_0.eContents().get(1);
		...
		private final Assignment cInvariantConditionsAssignment_7_4_1 = (Assignment)cGroup_7_4.eContents().get(1);
		private final Alternatives cInvariantConditionsAlternatives_7_4_1_0 = (Alternatives)cInvariantConditionsAssignment_7_4_1.eContents().get(0);
		private final RuleCall cInvariantConditionsEntityInvariantConditionParserRuleCall_7_4_1_0_0 = (RuleCall)cInvariantConditionsAlternatives_7_4_1_0.eContents().get(0);
		private final RuleCall cInvariantConditionsAttributeInvariantConditionParserRuleCall_7_4_1_0_1 = (RuleCall)cInvariantConditionsAlternatives_7_4_1_0.eContents().get(1);
		private final Keyword cRightParenthesisKeyword_7_5 = (Keyword)cGroup_7.eContents().get(5);
		private final Group cGroup_8 = (Group)cGroup.eContents().get(8);
		private final Keyword cCommaKeyword_8_0 = (Keyword)cGroup_8.eContents().get(0);
		private final Keyword cSUBKeyword_8_1 = (Keyword)cGroup_8.eContents().get(1);
		private final Keyword cLeftParenthesisKeyword_8_2 = (Keyword)cGroup_8.eContents().get(2);
		private final Assignment cChildrenGoalsAssignment_8_3 = (Assignment)cGroup_8.eContents().get(3);
		private final CrossReference cChildrenGoalsGoalCrossReference_8_3_0 = (CrossReference)cChildrenGoalsAssignment_8_3.eContents().get(0);
		private final RuleCall cChildrenGoalsGoalIDTerminalRuleCall_8_3_0_1 = (RuleCall)cChildrenGoalsGoalCrossReference_8_3_0.eContents().get(1);
		...
		private final Assignment cChildrenGoalsAssignment_8_4_1 = (Assignment)cGroup_8_4.eContents().get(1);
		private final CrossReference cChildrenGoalsGoalCrossReference_8_4_1_0 = (CrossReference)cChildrenGoalsAssignment_8_4_1.eContents().get(0);
		private final RuleCall cChildrenGoalsGoalIDTerminalRuleCall_8_4_1_0_1 = (RuleCall)cChildrenGoalsGoalCrossReference_8_4_1_0.eContents().get(1);
		...
		//"SUC"
		public Keyword getSUCKeyword_2() { return cSUCKeyword_2; }

		//"("
		public Keyword getLeftParenthesisKeyword_3() { return cLeftParenthesisKeyword_3; }

		//sucessCondition=(EntityAchieveCondition | AttributeAchieveCondition | Nothing)
		public Assignment getSucessConditionAssignment_4() { return cSucessConditionAssignment_4; }

		//EntityAchieveCondition | AttributeAchieveCondition | Nothing
		public Alternatives getSucessConditionAlternatives_4_0() { return cSucessConditionAlternatives_4_0; }

		//EntityAchieveCondition
		public RuleCall getSucessConditionEntityAchieveConditionParserRuleCall_4_0_0() { return cSucessConditionEntityAchieveConditionParserRuleCall_4_0_0; }

		//AttributeAchieveCondition
		public RuleCall getSucessConditionAttributeAchieveConditionParserRuleCall_4_0_1() { return cSucessConditionAttributeAchieveConditionParserRuleCall_4_0_1; }

		//Nothing
		public RuleCall getSucessConditionNothingParserRuleCall_4_0_2() { return cSucessConditionNothingParserRuleCall_4_0_2; }
		...
		//"ACT"
		public Keyword getACTKeyword_6_1() { return cACTKeyword_6_1; }

		//"("
		public Keyword getLeftParenthesisKeyword_6_2() { return cLeftParenthesisKeyword_6_2; }

		//activationCondition=(EntityAchieveCondition | AttributeAchieveCondition)
		public Assignment getActivationConditionAssignment_6_3() { return cActivationConditionAssignment_6_3; }

		//EntityAchieveCondition | AttributeAchieveCondition
		public Alternatives getActivationConditionAlternatives_6_3_0() { return cActivationConditionAlternatives_6_3_0; }

		//EntityAchieveCondition
		public RuleCall getActivationConditionEntityAchieveConditionParserRuleCall_6_3_0_0() { return cActivationConditionEntityAchieveConditionParserRuleCall_6_3_0_0; }

		//AttributeAchieveCondition
		public RuleCall getActivationConditionAttributeAchieveConditionParserRuleCall_6_3_0_1() { return cActivationConditionAttributeAchieveConditionParserRuleCall_6_3_0_1; }
		...
		//"INV"
		public Keyword getINVKeyword_7_1() { return cINVKeyword_7_1; }

		//"("
		public Keyword getLeftParenthesisKeyword_7_2() { return cLeftParenthesisKeyword_7_2; }

		//invariantConditions+=(EntityInvariantCondition | AttributeInvariantCondition)
		public Assignment getInvariantConditionsAssignment_7_3() { return cInvariantConditionsAssignment_7_3; }

		//EntityInvariantCondition | AttributeInvariantCondition
		public Alternatives getInvariantConditionsAlternatives_7_3_0() { return cInvariantConditionsAlternatives_7_3_0; }

		//EntityInvariantCondition
		public RuleCall getInvariantConditionsEntityInvariantConditionParserRuleCall_7_3_0_0() { return cInvariantConditionsEntityInvariantConditionParserRuleCall_7_3_0_0; }

		//AttributeInvariantCondition
		public RuleCall getInvariantConditionsAttributeInvariantConditionParserRuleCall_7_3_0_1() { return cInvariantConditionsAttributeInvariantConditionParserRuleCall_7_3_0_1; }
		...
		//invariantConditions+=(EntityInvariantCondition | AttributeInvariantCondition)
		public Assignment getInvariantConditionsAssignment_7_4_1() { return cInvariantConditionsAssignment_7_4_1; }

		//EntityInvariantCondition | AttributeInvariantCondition
		public Alternatives getInvariantConditionsAlternatives_7_4_1_0() { return cInvariantConditionsAlternatives_7_4_1_0; }

		//EntityInvariantCondition
		public RuleCall getInvariantConditionsEntityInvariantConditionParserRuleCall_7_4_1_0_0() { return cInvariantConditionsEntityInvariantConditionParserRuleCall_7_4_1_0_0; }

		//AttributeInvariantCondition
		public RuleCall getInvariantConditionsAttributeInvariantConditionParserRuleCall_7_4_1_0_1() { return cInvariantConditionsAttributeInvariantConditionParserRuleCall_7_4_1_0_1; }

		//")"
		public Keyword getRightParenthesisKeyword_7_5() { return cRightParenthesisKeyword_7_5; }

		//("," "SUB" "(" childrenGoals+=[Goal] ("," childrenGoals+=[Goal])* ")")?
		...
		//"SUB"
		public Keyword getSUBKeyword_8_1() { return cSUBKeyword_8_1; }

		//"("
		public Keyword getLeftParenthesisKeyword_8_2() { return cLeftParenthesisKeyword_8_2; }

		//childrenGoals+=[Goal]
		public Assignment getChildrenGoalsAssignment_8_3() { return cChildrenGoalsAssignment_8_3; }

		//[Goal]
		public CrossReference getChildrenGoalsGoalCrossReference_8_3_0() { return cChildrenGoalsGoalCrossReference_8_3_0; }

		//ID
		public RuleCall getChildrenGoalsGoalIDTerminalRuleCall_8_3_0_1() { return cChildrenGoalsGoalIDTerminalRuleCall_8_3_0_1; }
		...
		//childrenGoals+=[Goal]
		public Assignment getChildrenGoalsAssignment_8_4_1() { return cChildrenGoalsAssignment_8_4_1; }

		//[Goal]
		public CrossReference getChildrenGoalsGoalCrossReference_8_4_1_0() { return cChildrenGoalsGoalCrossReference_8_4_1_0; }

		//ID
		public RuleCall getChildrenGoalsGoalIDTerminalRuleCall_8_4_1_0_1() { return cChildrenGoalsGoalIDTerminalRuleCall_8_4_1_0_1; }
	...
	private final BlendedModelElements pBlendedModel;
	...
	@Inject
	public BlendedGrammarAccess(GrammarProvider grammarProvider,
		TerminalsGrammarAccess gaTerminals) {
		this.grammar = internalFindGrammar(grammarProvider);
		this.gaTerminals = gaTerminals;
		this.pBlendedModel = new BlendedModelElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.blended.Blended".equals(grammar.getName())) {
				return grammar;
			}
	...
	//BlendedModel:
	//	Condition | Goal | Activity;
	public BlendedModelElements getBlendedModelAccess() {
		return pBlendedModel;
	}
