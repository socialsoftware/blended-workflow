...
public class ConsoleManagement {
	public static String DATA_CONSOLE = "Data Console";
	public static String CONDITION_CONSOLE = "Condition Console";
	public static String ACTIVITY_CONSOLE = "Activity Console";
