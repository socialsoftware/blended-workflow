...
public class DataModelInstance extends DataModelInstance_Base {
	...
	private ArrayList<EntityInstance> visitedEntityInstanceNodes = new ArrayList<EntityInstance>();
	...
	private ArrayList<Entity> visitedEntityNodes = new ArrayList<Entity>();
	 ...
	 * Search Algorithms
	 ********************/
	public void searchEntity(Entity initNode, Entity targetNode, Relation edge, ArrayList<Entity> currentEntityPath, ArrayList<Relation> currentRelationPath ) {
		...
		if (initNode.equals(targetNode)) {
			...
			for (Relation relation : initNode.getRelations()) {
	...
	public void searchEntityInstance(EntityInstance initNode, EntityInstance targetNode, ArrayList<EntityInstance> currentPath) {
		...
		if (initNode.equals(targetNode)) {
			...
			for (RelationInstance relationInstance : initNode.getEntityInstanceOneRelationInstances()) {
			...
			for (RelationInstance relationInstance : initNode.getEntityInstanceTwoRelationInstances()) {
	...
	public EntityInstance getEntityInstance(EntityInstance startEntityInstance, EntityInstance targetEntityInstance) {
		searchEntityInstance(startEntityInstance, targetEntityInstance, new ArrayList<EntityInstance>());
