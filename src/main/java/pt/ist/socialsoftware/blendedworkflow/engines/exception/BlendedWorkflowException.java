...
public class BlendedWorkflowException extends Exception {
	...
	public enum BlendedWorkflowError {EMPTY_CONDITION_STRING, INVALID_CONDITION_STRING, INVALID_SPECIFICATION_NAME,
		...
		WORKLET_ADAPTER_ADDNODE, WORKLET_ADAPTER_EVALUATE, WORKLET_ADAPTER_PROCESS, INVALID_USER, INVALID_ROLE, INVALID_ATTRIBUTE_OPERATION, UMANAGED_RULE_TYPE, WORKLET_ADAPTER_EVALUATEPRECONDITION}
