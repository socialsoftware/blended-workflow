...
public class BlendedWorkflowException extends Exception {
	...
	public enum BlendedWorkflowError {EMPTY_CONDITION_STRING, INVALID_CONDITION_STRING, INVALID_SPECIFICATION_NAME,
		...
		NON_EXISTENT_WORKITEM_ID, FALSE_PRE_CONSTRAIN, YAWL_ADAPTER, WORKLET_ADAPTER, WORKLIST_MANAGER, BWPRESENTATION, YAWL_REGISTER_SERVICE, YAWL_REMOVE_SERVICE, YAWL_LOAD_SPECIFICATION, YAWL_REMOVE_CLIENT, YAWL_REGISTER_CLIENT}
