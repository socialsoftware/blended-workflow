...
public class ForAllConditionTest {
	...
	public void setUp() throws BlendedWorkflowException {
		...
		forAllCondition = new ForAllCondition(relation, entity2, existsEntityCondition);
...
/*
	...
	public void evaluateToFalse() throws BlendedWorkflowException {
		...
		assertEquals(TripleStateBool.FALSE, forAllCondition.evaluateWithDataModel(null));
	...
	@Test
	public void evaluateToSkipped() throws BlendedWorkflowException {
		Transaction.begin();
		//SKIPPED and SKIPPED
